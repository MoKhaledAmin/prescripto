...
const Appointment = () => {
    ...
    // Get Avaliable Reservation
    const getAvaliableReservation = async () => {
        setDoctorSlots([]);
    ...
    useEffect(() => {
        fetchDoctorInfo();
        getAvaliableReservation();
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [doctors, docId, doctorInfo]);
            ...
            <div>
                <div className='flex flex-col sm:flex-row gap-4'>
                    ...
                    <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
                        ...
                        <div>
                            <p className='flex items-center gap-1 text-sm font-medium text-gray-900 mt-3'>About <img className='w-4' src={assets.info_icon} alt='Info' /></p>
