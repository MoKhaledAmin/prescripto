...
const Profile = () => {
    ...
    const [userData, setUserData] = useState({
        ...
        email: 'MoKhaledAmin123@Gmail.Com',
        phone: '+201016379543',
        address: {
            line1: 'Elasawy ,Sedi Beshir',
            line2: 'Alexandria, Egypt'
        },
        gender: 'Male',
        dob: '1998-10-1'
    });
            ...
            <div className='max-w-lg flex flex-col gap-2 text-sm'>
                ...
                <div>
                    ...
                    <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
                        ...
                        {
                            isEdit ? <input className='max-w-28 bg-gray-100' type='date' value={userData.phone} onChange={(e) => setUserData((prev) => ({ ...prev, dob: e.target.value }))} /> : <p className='text-gray-400'>{userData.dob}</p>
                        }
                    </div>
                </div>
                <div className='mt-10'>
